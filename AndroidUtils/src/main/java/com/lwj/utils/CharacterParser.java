...
public final  class CharacterParser {
    ...
    private int getChsAscii(String chs) {
        ...
        try {
            ...
            LogUtil.e("ERROR:ChineseSpelling.class-getChsAscii(String chs)" + e);
        }
        return asc;
    }
    ...
    public static String getSpellStr(String name) {
        return CharacterParser.getInstance().getSpelling(name);
    }
